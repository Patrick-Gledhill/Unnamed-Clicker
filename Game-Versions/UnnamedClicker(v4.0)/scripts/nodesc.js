console.trace("%cMade by Patrick Gledhill (aka Pete). uC(4.0)", "color: #00ff00; padding: 15px; background: #202020;");
console.warn("%cI hope you didn't open this menu to cheat. Cheating in uC(4.0) does not make you cool or talented at all.", "color: #ffff00; padding: 15px; background: #202020;");
console.warn("%cDont even think about cheating.", "color: #ff8000; padding: 15px; background: #202020;");
console.warn("%cDon't even think about removing the watermark, ever. It will come after you.", "color: #ff0000; padding: 15px; background: #202020;");
